...
public class AbstractConstraint {
	...
	/**
	 * The visibility of the constraint. This is only implemented for the
	 * default painting methods of the constraints. When you create your
	 * painting methods in subclassed constraints or composites you should add a
